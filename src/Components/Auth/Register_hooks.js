...
const Register = () => {
  ...
  const handleOnchange = e => setInputValues(e.target.value)
  ...
  const handleSubmit = e => {
    ...
    if (isFormValid()) {
      ...
      firebase
        .auth()
        .createUserWithEmailAndPassword(inputValues({
          username: '',
          email: '',
        }))
        .then(createdUser => {
        ...
        <Form size='large' onSubmit={handleSubmit}>
          <Segment stacked>
            ...
            <Form.Input
              ...
              type='password'
              className={handleInputError(errors, 'password')}
              value={setInputValues.passwordConfirmation}
              onChange={handleOnchange}
            />
